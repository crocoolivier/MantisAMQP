...
<form action="<?php echo plugin_page( 'manage_config_edit' )?>" method="post">
	<table align="center" class="width75" cellspacing="1">
		...
		<tr <?php echo helper_alternate_class( )?>>
			<td>
				<?php echo plugin_lang_get( 'host' ) ?></td>
			<td colspan="2">
				<label>
					<input type="text" name="host" cols="10" rows="1" value="<?php echo string_attribute( $t_host ) ?>">
				</label>
			</td>
		</tr>
		<tr <?php echo helper_alternate_class( )?>>
			...
			<td colspan="2">
				<label>
					<input type="text" name="port" cols="10" rows="1" value="<?php echo string_attribute( $t_port ) ?>">
				</label>
			</td>
			...
			<td colspan="2">
				<label>
					<input type="text" name="user" cols="10" rows="1" value="<?php echo string_attribute( $t_user ) ?>">
				</label>
			</td>
		</tr><tr <?php echo helper_alternate_class( )?>>
			...
			<td colspan="2">
				<label>
					<input type="text" name="password" cols="10" rows="1" value="<?php echo string_attribute( $t_password ) ?>">
				</label>
			</td>
		</tr><tr <?php echo helper_alternate_class( )?>>
			...
			<td colspan="2">
				<label>
					<input type="text" name="vhost" cols="10" rows="1" value="<?php echo string_attribute( $t_vhost ) ?>">
				</label>	
			</td>
		</tr><tr <?php echo helper_alternate_class( )?>>
			...
			<td colspan="2">
				<label>
					<input type="text" name="exchange" cols="10" rows="1" value="<?php echo string_attribute( $t_exchange ) ?>">
				</label>
			</td>
		</tr>
		<tr>
